 ...
 *
 * Filter panel for product browsing with category, price, store, and sort options.
 */
...
import type { ProductFilters as ProductFiltersType } from '@org/types';
...
/**
 * ProductFilters provides filtering and sorting options for products
 */
export function ProductFilters({
  ...
  const hasActiveFilters =
    Object.values(localFilters).filter((v) => v !== undefined && v !== null)
      .length > 0;
